    ...
    return (
      <div className={styles.conteiner}>
        <div className={styles.main_box}>
          <div className={styles.main_sign_text}>Sign Up</div>
          ...
          <div type="submit" className={styles.main_button} onClick={this.submitHandler}>Sign Up</div>
          <div className={styles.main_question_text}>Create an account! <Link className={styles.main_link} to="/sign_in">Sign In</Link></div>
        </div>
      </div>
    )
  }
